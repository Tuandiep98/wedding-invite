    ...
    groups: [
      {
        ...
        guests: [
          ...
          { code: "thao", name: "Thảo", xung: "em", alias: [] },
          { code: "cuong-linh", name: "Cường & Linh", xung: "hai em", alias: [] },
          { code: "ha", name: "Hà", xung: "em", alias: [] },
          { code: "khang", name: "Khang", xung: "em", alias: [] },
          { code: "thang", name: "Thắng", alias: [] },
          { code: "my", name: "My", xung: "em", alias: [] },
          { code: "tu-cty", name: "Tú", alias: [] },
          { code: "khai", name: "Khải", alias: [] },
          { code: "bao", name: "Bảo & người thương", xung: "hai em", alias: ["ny"] },
          { code: "linh-pham", name: "Linh Phạm", xung: "em", alias: ["ny hà"] },
          { code: "linh", name: "Linh", xung: "em", alias: [] },
          { code: "duong", name: "Anh Dương", xung: "anh", alias: [] },
          { code: "hau-cty", name: "Hậu", xung: "em", alias: [] },
          { code: "tuan", name: "Tuấn", alias: [] },
          { code: "trang", name: "Trang", xung: "em", alias: [] },
      ...
      },
      {
        ...
        guests: [
          ...
          { code: "huy", name: "Huy", xung: "em", alias: [] },
        ],
      },
      {
        id: "dai-hoc",
